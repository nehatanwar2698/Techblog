...
<html>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark  primary-background navbar-fixed-top">
       <a class="navbar-brand" href="index.jsp"><span class="fa fa-desktop"></span> &nbsp;Technical Blog</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="#"><span class="	fa fa-bell-o"></span> Learn Programming with Neha </a>
      </li>
    ...
    <li class="nav-item active">
       ...
       <li class="nav-item">
                        <a class="nav-link" href="#" data-toggle="modal" data-target="#add-post-modal"><span class="fa fa-plus-circle"></span>Do Post</a>
                    </li>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container text-center">
                            ...
                            <img src="pics/<%=user.getProfile()%>" class="img-fluid" style="border-radius: 6    0%; max-width: 160px"/>
                ...
                <div class="modal-content" id="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="add-post-form" action="AddPostServlet" method="post">
                            ...
                            <div class="form-group">
                                <textarea name="pCode" class="form-control" placeholder="Enter your program(if any)"style="height: 15 0px"></textarea>
                            </div>
                            <div class="form-group">
        ...
        <script>
            $(document).ready(function (e) {
                ...
                $("#add-post-form").on("submit", function (event) {
                    ...
                    event.preventDefault(); //normal behaviour stop wich is syncronous 
